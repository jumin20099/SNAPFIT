...
export default function LoginPage({ open, onOpenChange, onSwitchToSignup }: LoginPageProps) {
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="max-w-md mx-auto space-y-6">
          ...
          <div className="space-y-3">
            <p className="text-center text-sm text-gray-600 mb-4">소셜 계정으로 로그인</p>
          ...
          <div className="text-center pt-6">
            <p className="text-sm text-gray-600">
              계정이 없으신가요?{" "}
              <Button variant="link" className="p-0 h-auto text-blue-600" onClick={onSwitchToSignup}>
                회원가입
              </Button>
            </p>
          </div>
