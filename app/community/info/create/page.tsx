      ...
      <div className="mx-auto max-w-4xl p-4">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">정보 공유</h1>
          </div>
          <p className="text-gray-600 dark:text-gray-400 ml-11">
            유용한 정보를 공유하고 함께 나누어요. 정확하고 도움이 되는 내용을 작성해주세요.
          </p>
        </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="공유하고 싶은 정보를 자세히 작성해주세요"
                  rows={10}
                  maxLength={10000}
          ...
          <Card className="border-green-200 dark:border-green-800">
            <CardContent className="pt-6">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-2">
                  <h4 className="font-medium text-green-900 dark:text-green-100">작성 가이드</h4>
                  <ul className="text-sm text-green-700 dark:text-green-300 space-y-1">
                    <li>• 유용하고 정확한 정보를 공유해주세요</li>
                    <li>• 출처가 명확한 정보를 우선적으로 작성해주세요</li>
                    <li>• 다른 사용자에게 도움이 되는 내용을 작성해주세요</li>
                    <li>• 개인정보나 저작권이 있는 내용은 피해주세요</li>
                  </ul>
                </div>
              </div>
            </CardContent>
