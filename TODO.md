...
### 서비스 레이어
- [x] CommunityService.java 생성 (통합 커뮤니티 비즈니스 로직)
- [x] PostService.java 생성 (게시글 CRUD, 태그 파싱)
- [x] ScrapService.java 생성 (스크랩 토글, 조회)
- [x] FollowService.java 생성 (팔로우/팔로잉 관리)
- [x] TagService.java 생성 (태그 정규화, 트렌딩)
- [x] CommentService.java 생성 (댓글 CRUD)
...
### 랭킹 시스템
- [x] RankingService.java 생성 (랭킹 점수 계산)
- [x] 랭킹 알고리즘 v1 구현 (가중치 기반)
- [x] Redis 캐시 연동 (랭킹 결과 60초 TTL)
- [x] 프론트엔드 랭킹 탭 구현
